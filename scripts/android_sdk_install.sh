...
if [ ! -e android-sdk-linux/tools/bin ];then
    ...
    ( sleep 5 && while [ 1 ]; do sleep 1; echo y; done ) | android update sdk --silent -u -a -f -t ${ANDROPACKS}    >/dev/null
    ...
    ( sleep 5 && while [ 1 ]; do sleep 1; echo y; done ) | sdkmanager --licenses    >/dev/null
