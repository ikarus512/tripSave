...
pushd platforms/android/build/outputs/apk
    ...
    keystoreFile=ikarus512-trackSave.keystore
    keystoreAlias=ikarus512trackSave
    ...
    for apkFile in $(ls android-*-release-unsigned.apk);do
        ...
        plat=$(echo $apkFile | perl -e '$_=<>; s/^\w+-|-release-unsigned.apk$//g; print;')
        apkFileOut=trackSave-$plat.apk
